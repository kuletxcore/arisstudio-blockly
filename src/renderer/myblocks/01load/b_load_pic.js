...
const jsondesc = {
    "type": `${blockname}`,
    "message0": "Load %1 image nickname %2 Filename %3",
    "args0": [
        {
            "type": "field_dropdown",
            "name": "drop1",
    ...
    "nextStatement": null,
    "colour": 230,
    "tooltip": "Foreground images must be placed in /data/image/foreground.\nMidground images must be placed in /data/image/midground.\nBackground images must be placed in /data/image/background.",
    "helpUrl": ""
  }
